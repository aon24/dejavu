...
@author: aon
'''
from ..a_design.a_screens import blankScreens
...
class t_lesson(Page):
    ...
    def __init__(self, form):
        ...
        self.jsCssUrlEdit = ['jsv?api/pages/t_lesson/t_lesson.js']
        self.jsCssUrlRead = ['jsv?api/pages/t_lesson/t_lesson_read.js']
        super().__init__(form)
