...
class Toolbar(object):
    ...
    save = _btnD(' СОХРАНИТЬ '.replace(' ', '\xa0'), 'save', title='Ctrl+S', className='toolbar-button')
    publish = _btnD(' ОПУБЛИКОВАТЬ '.replace(' ', '\xa0'), 'publish', title='выложить на сайт', className='toolbar-button')
    close_ = _btnD(' ЗАКРЫТЬ '.replace(' ', '\xa0'), 'close', title='[Esc] - закрыть окно', className='toolbar-button')

    close = _btnD(' ЗАКРЫТЬ', 'close', title='[Esc] - закрыть окно', className='toolbar-button', **style(width='67mm'))
    close2 = _btnD(' C L O S E '.replace(' ', '\xa0'), 'close', title='Esc', className='toolbar-button')
    ...
    saveClose2 = _btnD(' S A V E   A N D   C L O S E '.replace(' ', '\xa0'), 'saveClose', title='Shift+Esc', className='toolbar-button')

    save2 = _btnD('   S A V E   '.replace(' ', '\xa0'), 'save', title='Ctrl+S', className='toolbar-button')
